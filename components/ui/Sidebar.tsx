...
const Sidebar = ({children}: PropsWithChildren) => {
  ...
  return <SidebarContext.Provider value={{isExpanded, toggleExpanded}}>{children}</SidebarContext.Provider>;
};
...
export {SidebarContext, Sidebar, SidebarContent, SidebarTrigger};
