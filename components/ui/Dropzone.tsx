...
const Dropzone = ({name, onDrop, maxSize = MAX_FILE_SIZE, multiple, disabled, accept, ...props}: DropzoneProps) => {
  ...
  return (
    <div
      {...getRootProps()}
      className={cn(
        "flex cursor-pointer items-center gap-6 rounded-md border-2 border-dashed px-3 py-5 transition-colors hover:bg-slate-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-400 focus-visible:ring-offset-2",
