    ...
    <article className="group w-auto shrink-0 sm:even:mt-20">
      <Link
        ...
        <div className="flex h-full w-full flex-1 flex-col gap-2">
          <p className="font-poppins text-foreground group-hover:text-primary text-xl font-semibold transition-colors">
            {name}
          </p>

          <p className="text-muted-foreground line-clamp-3 overflow-hidden text-sm leading-7 text-ellipsis">
