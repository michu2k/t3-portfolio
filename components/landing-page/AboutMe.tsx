  ...
  return (
    <PageSection id="about" heading="Personal Details" subheading="01. About Me">
      <div className="flex flex-col gap-14 md:flex-row md:items-center">
        {imageObj ? (
          <div className="relative my-auto h-64 w-56 flex-shrink-0 rounded-lg after:absolute after:-bottom-2 after:-right-2 after:left-24 after:top-10 after:-z-10 after:rounded-br-2xl after:bg-secondary md:h-80 md:w-72">
